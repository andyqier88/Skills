...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      if (!this.isShow && !this.isAutoScroll && 1 * this.getClientHeight() < this.getScrollTop()) {
        this.isShow = true;
      }
...
.global-goto-top {
  ...
  span {
    background: url(data:image/png;base64,)
      no-repeat;
      // background: url('http://cdn.16988.cn/res/html/pc/images/morentouxiang.png') no-repeat;
    width: 40px;
    height: 40px;
